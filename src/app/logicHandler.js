...
import {getData, postData} from './api/page';
...
export default function LogicHandlerLevent () {
  ...
  const [stopTime, setStopTime] = useState(localStorage.getItem('stopTime') || matrixData.firstSet.firstStopTime);
  const [url, setUrl] = useState(localStorage.getItem('url') || matrixData.firstSet.firstUrl);
  const [question, setQuestion] = useState(localStorage.getItem('question') || matrixData.firstSet.question);
  const [choice1, setChoice1] = useState(localStorage.getItem('choice1') || matrixData.firstSet.scenario1.choice);
  const [choice2, setChoice2] = useState(localStorage.getItem('choice2') || matrixData.firstSet.scenario2.choice);
  const [saveChoice, setSaveChoice] = useState(localStorage.getItem('saveChoice') || "");
